                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                           id="name" name="name" value="{{ old('name', $duplicateAsset->name ?? '') }}" required>
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('serial_number') is-invalid @enderror" 
                                           id="serial_number" name="serial_number" value="{{ old('serial_number', $duplicateAsset->serial_number ?? '') }}">
                                    @error('serial_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('model_id') is-invalid @enderror" id="model_id" name="model_id" required>
                                        ...
                                        @foreach($assetModels as $model)
                                            <option value="{{ $model->id }}" {{ old('model_id', $duplicateAsset->model_id ?? '') == $model->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status_id') is-invalid @enderror" id="status_id" name="status_id" required>
                                        ...
                                        @foreach($statuses as $status)
                                            <option value="{{ $status->id }}" {{ old('status_id', $duplicateAsset->status_id ?? '') == $status->id ? 'selected' : '' }}>
                                                {{ $status->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('location_id') is-invalid @enderror" id="location_id" name="location_id">
                                        ...
                                        @foreach($locations as $location)
                                            <option value="{{ $location->id }}" {{ old('location_id', $duplicateAsset->location_id ?? '') == $location->id ? 'selected' : '' }}>
                                                {{ $location->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('department_id') is-invalid @enderror" id="department_id" name="department_id">
                                        ...
                                        @foreach($departments as $department)
                                            <option value="{{ $department->id }}" {{ old('department_id', $duplicateAsset->department_id ?? '') == $department->id ? 'selected' : '' }}>
                                                {{ $department->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('assigned_to') is-invalid @enderror" id="assigned_to" name="assigned_to">
                                        ...
                                        @foreach($users as $user)
                                            <option value="{{ $user->id }}" {{ old('assigned_to', $duplicateAsset->assigned_to ?? '') == $user->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('purchase_date') is-invalid @enderror" 
                                           id="purchase_date" name="purchase_date" value="{{ old('purchase_date', $duplicateAsset->purchase_date ?? '') }}">
                                    @error('purchase_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('purchase_cost') is-invalid @enderror" 
                                               id="purchase_cost" name="purchase_cost" value="{{ old('purchase_cost', $duplicateAsset->purchase_cost ?? '') }}">
                                        @error('purchase_cost')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror" 
                                              id="notes" name="notes" rows="3">{{ old('notes', $duplicateAsset->notes ?? '') }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
...
$(document).ready(function() {
    // Auto-gerar tag do ativo baseado no nome
    $('#name').on('input', function() {
        let name = $(this).val();
        if (name && !$('#asset_tag').val()) {
            let tag = 'AT-' + name.substring(0, 6).toUpperCase().replace(/\s/g, '');
            $('#asset_tag').val(tag);
        }
    });
});
